...
export default function Home() {
  return (
    <section className="min-h-screen flex items-center bg-white dark:bg-[#3333]">
      <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        {/* <h1 className="mb-4 text-4xl font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-5xl xl:text-6xl dark:text-white">Bakım Çalışması</h1> */}
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-[#333] mb-10">
